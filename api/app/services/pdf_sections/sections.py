"""Kundli PDF section / page / table builders — one function per report
section. Split out of the former 2676-line pdf_sections.py; the shared
helpers + chart geometry live in ._common."""

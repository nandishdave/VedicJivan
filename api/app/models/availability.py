...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="divisional",      label="Divisional Charts",      description="All 18 divisional charts (D2–D60) with SVG diagrams and planet positions.",                    is_paid=False, enabled=True, order=21),
    ReportSection(id="shodashvarga",   label="Shodashvarga Table",     description="Compact grid showing each planet's sign across all divisional charts at a glance.",             is_paid=False, enabled=True, order=22),
    ReportSection(id="friendship",      label="Friendship Table",       description="Permanent (Naisargika), Temporary (Tatkalika) and Compound (Panchadha) friendship matrices.", is_paid=False, enabled=True, order=23),
    ReportSection(id="shadbala",        label="Planetary Strength",     description="Shadbala — which planets are strong or weak and why.",                                         is_paid=False, enabled=True, order=24),
    ReportSection(id="western_aspects", label="Planetary Aspects (Western)", description="Western-style angular aspects (conjunction, opposition, trine, square, sextile, minor).", is_paid=False, enabled=True, order=25),
    ReportSection(id="graha_drishti",  label="Graha Drishti (Vedic Aspects)",description="Classical Vedic planetary aspects: 7th for all, plus Mars 4/8, Jupiter 5/9, Saturn 3/10, Rahu/Ketu 5/9.", is_paid=False, enabled=True, order=26),
    ReportSection(id="planet_positions",label="Planet Positions",       description="Complete planet ephemeris table with degrees, sign, nakshatra, dignity.",                      is_paid=False, enabled=True, order=27),
    ReportSection(id="numerology",      label="Numerology",             description="Moolank, Bhagyank, Namank and personal year analysis (Chaldean + Vedic).",                     is_paid=False, enabled=True, order=28),
    ReportSection(id="varshaphal",      label="Varshaphal (Annual)",    description="Tajik annual chart at solar return, Muntha bhava focus, and Mudda Dasha period predictions.", is_paid=False, enabled=True, order=29),
    ReportSection(id="lal_kitab_calc",  label="Lal Kitab Calculation",  description="Lal Kitab birth details, planetary table (house-based sign), Lagna chart, and Lal Kitab Dasha with sub-periods.", is_paid=False, enabled=True, order=30),
    ReportSection(id="lal_kitab",       label="Lal Kitab Predictions",  description="Per-planet narrative + Lal Kitab remedies based on house placement.",                            is_paid=False, enabled=True, order=31),
    ReportSection(id="remedies",        label="Gemstone & Remedies",    description="Gemstone recommendations and personalised remedial measures.",                                 is_paid=False, enabled=True, order=29),

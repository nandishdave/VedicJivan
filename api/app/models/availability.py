...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="ascendant",       label="Ascendant",              description="Lagna explanation and your ascendant's character traits.",                                     is_paid=False, enabled=True, order=6),
    ReportSection(id="nakshatra",       label="Nakshatra",              description="Lunar mansion details, ruling deity, symbol, and pada interpretation.",                        is_paid=False, enabled=True, order=7),
    ReportSection(id="character_life",  label="Character & Life",       description="Personality traits, life patterns, and natural disposition.",                                  is_paid=False, enabled=True, order=8),
    ReportSection(id="yogas",           label="Yogas",                  description="Classical planetary combinations present in the chart.",                                       is_paid=False, enabled=True, order=9),
    ReportSection(id="doshas",          label="Doshas & Afflictions",   description="Kaal Sarp, Pitra, Guru Chandal, Mangal Dosha etc. + remedies.",                                is_paid=False, enabled=True, order=10),
    ReportSection(id="bhava_analysis",  label="Bhava (House) Analysis", description="House-by-house analysis of all 12 bhavas.",                                                    is_paid=False, enabled=True, order=11),
    ReportSection(id="manglik",         label="Mangal Dosha",           description="Manglik dosha check from Lagna and Moon, with severity and cancellations.",                    is_paid=False, enabled=True, order=12),
    ReportSection(id="sadesati",        label="Sade Sati",              description="Saturn's 7.5-year transit cycle through Moon's sign and adjacent signs.",                      is_paid=False, enabled=True, order=13),
    ReportSection(id="gochar",          label="Gochar (Transits)",      description="Current planetary transits over the natal chart.",                                             is_paid=False, enabled=True, order=14),
    ...
    ReportSection(id="western_aspects", label="Planetary Aspects (Western)", description="Western-style angular aspects (conjunction, opposition, trine, square, sextile, minor).", is_paid=False, enabled=True, order=20),
    ReportSection(id="planet_positions",label="Planet Positions",       description="Complete planet ephemeris table with degrees, sign, nakshatra, dignity.",                      is_paid=False, enabled=True, order=21),
    ReportSection(id="numerology",      label="Numerology",             description="Moolank, Bhagyank, Namank and personal year analysis (Chaldean + Vedic).",                     is_paid=False, enabled=True, order=22),
    ReportSection(id="remedies",        label="Gemstone & Remedies",    description="Gemstone recommendations and personalised remedial measures.",                                 is_paid=False, enabled=True, order=23),

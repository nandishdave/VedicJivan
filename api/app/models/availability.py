...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="divisional",      label="Divisional Charts",      description="D9 (marriage), D10 (career), D7 (children) analysis.",                                         is_paid=False, enabled=True, order=20),
    ReportSection(id="friendship",      label="Friendship Table",       description="Permanent (Naisargika), Temporary (Tatkalika) and Compound (Panchadha) friendship matrices.", is_paid=False, enabled=True, order=21),
    ReportSection(id="shadbala",        label="Planetary Strength",     description="Shadbala — which planets are strong or weak and why.",                                         is_paid=False, enabled=True, order=22),
    ReportSection(id="western_aspects", label="Planetary Aspects (Western)", description="Western-style angular aspects (conjunction, opposition, trine, square, sextile, minor).", is_paid=False, enabled=True, order=23),
    ReportSection(id="graha_drishti",  label="Graha Drishti (Vedic Aspects)",description="Classical Vedic planetary aspects: 7th for all, plus Mars 4/8, Jupiter 5/9, Saturn 3/10, Rahu/Ketu 5/9.", is_paid=False, enabled=True, order=24),
    ReportSection(id="planet_positions",label="Planet Positions",       description="Complete planet ephemeris table with degrees, sign, nakshatra, dignity.",                      is_paid=False, enabled=True, order=25),
    ReportSection(id="numerology",      label="Numerology",             description="Moolank, Bhagyank, Namank and personal year analysis (Chaldean + Vedic).",                     is_paid=False, enabled=True, order=26),
    ReportSection(id="remedies",        label="Gemstone & Remedies",    description="Gemstone recommendations and personalised remedial measures.",                                 is_paid=False, enabled=True, order=27),

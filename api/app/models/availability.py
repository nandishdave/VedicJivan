...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="kp_system",       label="KP System / Nakshatra Nadi", description="Krishnamurti Paddhati sub-lords: ruling planets, cuspal positions, and planetary sub-lords (KP ayanamsa + Placidus cusps).", is_paid=False, enabled=True, order=25),
    ReportSection(id="friendship",      label="Friendship Table",       description="Permanent (Naisargika), Temporary (Tatkalika) and Compound (Panchadha) friendship matrices.", is_paid=False, enabled=True, order=26),

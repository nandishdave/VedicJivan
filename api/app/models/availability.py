...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="yogini_dasha",   label="Yogini Dasha",          description="36-year Yogini Dasha cycle (8 yoginis) — excellent for 1-2 year event timing.",                 is_paid=False, enabled=True, order=20),

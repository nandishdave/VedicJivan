...
DEFAULT_REPORT_SECTIONS: list[ReportSection] = [
    ...
    ReportSection(id="pratyantar",      label="Pratyantar Dasha",       description="Sub-sub-periods (3rd level) within each Antardasha.",                                          is_paid=False, enabled=True, order=17),
    ReportSection(id="divisional",      label="Divisional Charts",      description="D9 (marriage), D10 (career), D7 (children) analysis.",                                         is_paid=False, enabled=True, order=18),

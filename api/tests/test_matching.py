...
_CASES = [
    ...
    # Maitri enemy-case (Mars×Mercury → 0.5) — the graha-maitri table anchor.
    ("Nandish&Helena", ("1988-11-11", "12:50", 23.0, 70.9),
     ("1987-10-15", "04:45", 23.033, 72.583),
     [1, 1, 3, 3, 0.5, 6, 0, 8], 22.5, "No", "High"),
]

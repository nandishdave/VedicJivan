...
export default function HomePage() {
  return (
    <>
      {/* ===== HERO SECTION ===== */}
      <section className="relative overflow-hidden bg-dark-gradient py-20 sm:py-28 lg:py-36">
        <FloatingElements />
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <AnimateOnScroll animation="fadeUp" delay={0.6}>
              <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 sm:text-xl">
                Get authentic Vedic astrology consultations, personalized Kundli
                reports, and expert guidance for career, relationships, health, and
                prosperity.
              </p>
            </AnimateOnScroll>
            ...
            {services.map((service, i) => (
              <AnimateOnScroll key={service.slug} animation="fadeUp" delay={i * 0.1}>
                <Link href={`/services/${service.slug}`} className="block h-full">
                  <TiltCard className="h-full rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-shadow hover:shadow-lg">

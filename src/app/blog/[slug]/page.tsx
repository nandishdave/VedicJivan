        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            <AnimateOnScroll animation="fadeUp">
              <article className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:text-vedic-dark dark:prose-headings:text-gray-100 prose-p:text-gray-600 dark:prose-p:text-gray-400 prose-a:text-primary-600 dark:prose-a:text-primary-400 prose-strong:text-vedic-dark dark:prose-strong:text-gray-100 prose-li:text-gray-600 dark:prose-li:text-gray-400 prose-blockquote:text-gray-600 dark:prose-blockquote:text-gray-400 dark:prose-blockquote:border-gray-600">
                <p className="lead text-xl text-gray-700 dark:text-gray-300">{post.excerpt}</p>
            ...
            <AnimateOnScroll animation="fadeUp" delay={0.1}>
              <div className="mt-10 flex flex-wrap gap-2 border-t border-gray-100 dark:border-white/10 pt-6">
                {post.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full bg-gray-100 dark:bg-gray-800 px-3 py-1 text-sm text-gray-600 dark:text-gray-400"
                  >
                    #{tag}
                  </span>
                ))}
            ...
            <AnimateOnScroll animation="fadeUp" delay={0.15}>
              <div className="mt-6 flex items-center gap-4 border-t border-gray-100 dark:border-white/10 pt-6">
                <span className="text-sm font-semibold text-vedic-dark dark:text-gray-100">
                  Share this article:
                </span>
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30 text-green-600 hover:bg-green-200"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 hover:bg-blue-200"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 hover:bg-blue-200"
            ...
            <AnimateOnScroll animation="fadeUp" delay={0.2}>
              <div className="mt-10 rounded-2xl border border-gray-100 dark:border-white/10 bg-cream dark:bg-dark-surface-warm p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-heading text-lg font-bold text-vedic-dark dark:text-gray-100">
                      {post.author}
                    </h4>
